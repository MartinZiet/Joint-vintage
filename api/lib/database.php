<?php
	...
	class database {
		...
		/* poni�sza funkcja przyjmuje:
			...
			$debug - je�li ustawione na true, wypisze si� tre�� ka�dego zapytania i jego status
		*/
		...
		/* poni�sza funkcja pobiera rekordy z bazy. 
			...
			Funkcja zwraca tablic� pobranych rekord�w. Ka�dy rekord jest tablic� asocjacyjn�.
		*/
